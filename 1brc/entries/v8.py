"""
    Update:
        - Used chunking to allow for parallel processing of the file.
...
def main(file_path: str, start_byte: int, end_byte: int) -> dict:
    ...
    with open(file_path, "rb") as file:
        ...
        with mmap.mmap(
            ...
            while mmapped_file.tell() < end_byte:
...
if __name__ == '__main__':
    ...
    with multiprocessing.Pool(processes=CPU_COUNT) as p:
        cities: list[dict] = p.starmap(main, chunks)
